 ...
 * @author Dell
 */
public class SellerFXMLController implements Initializable {
    ...
    @FXML
    private void addAnimalBtnAction(ActionEvent event) throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("AddAnimalFXML.fxml"));
        bp.setCenter(pane);
    }


    @FXML
    private void orderBtnAction(ActionEvent event) throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("OrderFXML.fxml"));
        bp.setCenter(pane);
    }
